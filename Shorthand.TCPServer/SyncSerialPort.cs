...
namespace DevLib.IO.Ports
{
    ...
    public class SyncSerialPort : MarshalByRefObject, IDisposable
    {
        ...
        public SyncSerialPort(Action<string> logger, string portName = "COM1", int baudRate = 9600, Parity partity = Parity.None, int dataBits = 8, StopBits stopBits = StopBits.One)
        {
            _logger = logger;
        ...
        /// </summary>
        public bool IsOpen => this._serialPort?.IsOpen ?? false;
